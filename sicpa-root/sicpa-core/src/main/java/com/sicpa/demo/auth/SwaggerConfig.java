...
public class SwaggerConfig{
    ...
    public Docket apiDocket() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.sicpa.demo.controller")).paths(PathSelectors.any()).build().apiInfo(getApiInfo());
    }
